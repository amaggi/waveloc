# -*- coding: utf-8 -*-
#
# WaveLoc documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../PyProgs'))
...
project = u'waveloc'
copyright = u'2012, Alessia Maggi'
